...
use Omnipay\Iyzico\Models\PayWithIyzicoRequestModel;
...
class PayWithIyzicoRequest extends RemoteAbstractRequest
{
    protected $endpoint = "/payment/pay-with-iyzico/initialize";
    ...
    public function getData()
    {
        ...
        $request_params = new PayWithIyzicoRequestModel([
     ...
     */
    protected function token(PayWithIyzicoRequestModel $request_model): string
    {
    ...
    protected function createResponse($data): PayWithIyzicoResponse
    {
        return $this->response = new PayWithIyzicoResponse($this, $data);
    }
}
